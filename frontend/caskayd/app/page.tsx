    ...
    <div className="w-full max-w-2xl mx-auto relative mb-16">
      {/* REMOVED: pointer-events-none from the div below */}
      <div className="relative flex items-center w-full h-16 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 px-6 shadow-2xl overflow-hidden select-none">
        ...
        {/* ADDED: pointer-events-auto just in case */}
        <button 
          onClick={() => router.push("/signup")}
          className="bg-[#ff6b35] text-white font-semibold px-6 py-2 rounded-full ml-4 transition-colors hover:bg-[#e55a2b] pointer-events-auto cursor-pointer"
        >
          Search
        </button>
      </div>
