  ...
  return (
    <div className="page-wrapper font-sans">
      ...
      <nav className="sticky top-0 w-full backdrop-blur-md bg-black/10 border-b border-white/10 z-50 transition-all">
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden absolute top-20 left-0 w-full bg-[#1d0b34]/95 backdrop-blur-xl border-b border-white/10 flex flex-col py-4 px-6 gap-4 shadow-2xl animate-in slide-in-from-top-2 duration-200">
            <a
              href="https://calendly.com/jacey77n/intro-chat"
              target="_blank"
              rel="noopener noreferrer"
        ...
        <>
          ...
          <main className="relative z-10 flex flex-col items-center justify-center text-center pt-24 md:pt-32 pb-48 max-w-5xl mx-auto px-4">
            ...
            <div className="w-full max-w-2xl mx-auto relative mb-16">
              <div className="relative flex items-center w-full h-16 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 px-6 shadow-2xl overflow-hidden select-none">
                <Search className="w-5 h-5 md:w-6 md:h-6 text-white/50 mr-3 md:mr-4 flex-shrink-0" />
                
                {/* Applied responsive text size and truncate */}
                <div className="relative flex-1 h-full flex items-center overflow-hidden">
                  <input
                    type="text"
                    readOnly
                    tabIndex={-1}
                    className="w-full h-full bg-transparent outline-none text-white text-sm sm:text-base md:text-lg placeholder-transparent cursor-default truncate"
                    aria-label="Search creators"
                  />
                  <div
                    className={`absolute left-0 w-full text-white font-semibold text-sm sm:text-base md:text-lg pointer-events-none transition-opacity duration-500 ease-in-out truncate pr-2 ${
                ...
                <button 
                  onClick={() => router.push("/signup")}
                  className="bg-[#ff6b35] text-white font-semibold px-4 md:px-6 py-2 rounded-full ml-2 md:ml-4 transition-colors hover:bg-[#e55a2b] pointer-events-auto cursor-pointer text-sm md:text-base whitespace-nowrap"
                >
                  Search
                </button>
              </div>
